...
\newcommand{\ThesisPhone}{0151-21340235}
...
A new open source tool for secure and distributed file synchronization with the
name \frqq\texttt{brig}\flqq is presented. Most established ways to exchange
files rely on a central, often company controlled, central instance or have
other design deficits. The shown alternative describes the usage of a
