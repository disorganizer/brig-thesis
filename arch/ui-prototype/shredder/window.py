...
class MainWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, application):
        Gtk.ApplicationWindow.__init__(
            self, title='brig', application=application
        )

        # Set the css name:
        self.set_name('ShredderWindow')
        self.set_title(shredder.APP_TITLE)
        self.set_default_size(950, 610)
        ...
        self.headerbar.pack_start(online_switch)
        ...
        main_menu.append_item(
            _create_item(_('Browse Files'), 'app.browse-files', 'emblem-system')
        )
        main_menu.append_item(
            _create_item(_('Handle Remotes'), 'app.handle-remotes', 'emblem-system')
        )
        main_menu.append_item(
            _create_item(_('Handle Repositories'), 'app.handle-repositories', 'emblem-system')
        )
        main_menu.append_item(
            _create_item(_('Show History'), 'app.show-history', 'emblem-system')
        )
        main_menu.append_item(
        ...
        main_menu.append_item(
            _create_item(_('Search Mode'), 'app.search', 'find-location-symbolic')
        )
        main_menu.append_item(
